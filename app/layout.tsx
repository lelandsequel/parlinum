      ...
      <body className={`${geistSans.variable} ${geistMono.variable} antialiased bg-[#0a0f1a] text-white`}>
        ...
        <nav className="fixed top-0 left-0 right-0 z-50 px-6 md:px-8 py-5 bg-[#0a0f1a]/90 backdrop-blur-sm border-b border-white/5">
          <div className="max-w-[1400px] mx-auto flex justify-between items-center">
            ...
            <Link
              href="/contact"
              className="text-xs uppercase tracking-widest border border-[#c9a227] text-[#c9a227] px-5 py-2.5 hover:bg-[#c9a227] hover:text-[#0a0f1a] transition-all"
            >
              Get Started
            </Link>
          </div>
          ...
          <div className="max-w-[1400px] mx-auto px-6 md:px-8 py-16">
            <div className="grid md:grid-cols-4 gap-12">
              <div className="md:col-span-2">
                <div className="text-lg font-bold tracking-wide mb-4">PARLINUM</div>
              ...
              <div>
                <div className="text-xs uppercase tracking-widest text-neutral-600 mb-4">Services</div>
              ...
              <div>
                <div className="text-xs uppercase tracking-widest text-neutral-600 mb-4">Contact</div>
